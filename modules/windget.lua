...
function windget.window:CreateTitleBar(name, parent)
  ...
  windget.widget:SkinButton(frame.close, "Interface\\AddOns\\mkUtils\\img\\close.tga")
  ...
  if parent:IsResizable() then
    ...
    windget.widget:SkinButton(frame.max, "Interface\\AddOns\\mkUtils\\img\\max.tga")
    ...
    windget.widget:SkinButton(frame.min, "Interface\\AddOns\\mkUtils\\img\\min.tga")
